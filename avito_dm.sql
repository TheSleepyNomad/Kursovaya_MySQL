...
CREATE TABLE `ad` (
  ...
  `ad_mode_id` int unsigned NOT NULL COMMENT 'Ссылка на тип привелегий объявления(вип, обычное и т.д)',
  `ad_category_id` int unsigned NOT NULL COMMENT 'Ссылка на наименование категории',
  `ad_product_condition_id` int unsigned NOT NULL COMMENT 'Ссылка на качество товара в объявлении(бу или новый)',
...
-- Dump completed on 2020-12-16 13:25:03
